#ifndef CENTERED_CANONICAL_DISTRIBUTION
#define CENTERED_CANONICAL_DISTRIBUTION
...
public:
  ...
  auto operator()(RNG &g) -> result_type {
    ...
    constexpr auto full_range =
        ...
        static_cast<RealType>(!RightClosed) + // right interval might be closed
    ...
    if (val <= cutoff) {
      ...
      if constexpr (stub_right) {
        ...
        return -static_cast<RealType>(RNG::max() - val) * one_over_range;
      }
    }
  }
};
...
public:
  ...
  template <bool FwdDirection = true> inline auto operator()() -> result_type {
    ...
    constexpr auto full_range =
        ...
        static_cast<double>(!RightClosed) + // right interval might be closed
...
#endif // CENTERED_CANONICAL_DISTRIBUTION
